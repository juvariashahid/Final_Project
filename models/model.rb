...
def return_book(all_books, genre)
  puts all_books
  @book_storage = []
  all_books[genre].each_key do |book|
   @book_storage.push(all_books[genre][book]["first_page"])
  end
  return @book_storage
end

def return_amazon(all_books, genre)
  @amazon_storage = []
  all_books[genre].each_key do |book|
    @amazon_storage.push(all_books[genre][book]["amazon_link"])
  end
  return @amazon_storage
end

# puts return_book("fantasy")
# puts return_amazon("fantasy")